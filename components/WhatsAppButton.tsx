...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className={`inline-flex items-center gap-2.5 bg-rojo text-white px-6 py-3.5 rounded-lg font-semibold text-base shadow-[0_4px_14px_rgba(184,52,43,0.28)] hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(184,52,43,0.34)] transition ${className}`}
    >
